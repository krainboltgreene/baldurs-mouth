defmodule CoreWeb.AccountAuthenticationHelpersTest do
  ...
  describe "on_mount: mount_current_account" do
    test "assigns current_account based on a valid account_token", %{conn: conn, account: account} do
      ...
      {:cont, updated_socket} =
        CoreWeb.AccountAuthenticationHelpers.on_mount(
          :mount_current_account,
          %{},
          session,
          %LiveView.Socket{}
        )
  ...
  describe "on_mount: ensure_authenticated" do
    ...
    test "redirects to login page if there isn't a valid account_token", %{conn: conn} do
      ...
      {:halt, updated_socket} =
        CoreWeb.AccountAuthenticationHelpers.on_mount(:ensure_authenticated, %{}, session, socket)
