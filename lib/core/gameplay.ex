defmodule Core.Gameplay do
  use EctoInterface, [Core.Gameplay.Spell, :spells, :spell]
  use EctoInterface.Read.Slug, [Core.Gameplay.Spell, :spell]
  use EctoInterface.Read.Tagged, [Core.Gameplay.Spell, :spells]
  use EctoInterface, [Core.Gameplay.Background, :backgrounds, :background]
  use EctoInterface.Read.Slug, [Core.Gameplay.Background, :background]
  use EctoInterface, [Core.Gameplay.Character, :characters, :character]
  use EctoInterface, [Core.Gameplay.Class, :classes, :class]
  use EctoInterface.Read.Slug, [Core.Gameplay.Class, :class]
  use EctoInterface, [Core.Gameplay.Inventory, :inventories, :inventory]
  use EctoInterface, [Core.Gameplay.Item, :items, :item]
  use EctoInterface.Read.Tagged, [Core.Gameplay.Item, :items]
  use EctoInterface.Read.Slug, [Core.Gameplay.Item, :item]
  use EctoInterface, [Core.Gameplay.LineageCategory, :lineage_categories, :lineage_category]
  use EctoInterface.Read.Slug, [Core.Gameplay.LineageCategory, :lineage_category]
  use EctoInterface, [Core.Gameplay.Lineage, :lineages, :lineage]
  use EctoInterface.Read.Slug, [Core.Gameplay.Lineage, :lineage]
  use EctoInterface.Write, [Core.Gameplay.Level, :level, :changeset, :changeset]
